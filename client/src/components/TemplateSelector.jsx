...
const TemplateSelector = ({ selectedTemplate, onChange }) => {
  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        <div className="absolute top-full w-xs p-3 mt-2 space-y-3 z-20 bg-white rounded-md border border-gray-200 shadow-sm">
            ...
            <div
              ...
              className={`relative p-3 border rounded-md cursor-pointer transition-all ${
                selectedTemplate === template.id
                  ...
                  : "boder-gray-300 hover:border-gray-400 hover:bg-gray-100"
              }`}
            >
              {selectedTemplate === template.id && (
              ...
              <div className="space-y-1">
                ...
                <div className="mt-2p-2 bg-blue-50 rounded text-xs text-gray-500 italic">
                  {template.preview}
                </div>
              </div>
            </div>
